...
public abstract class DB
{
	...
	public abstract int read(Integer key, Set<String> fields, HashMap<String,String> value);

	public abstract int update(Integer key, HashMap<String,String> value);

	public abstract int insert(Integer key, HashMap<String,String> value);

	public abstract int delete(Integer key);
